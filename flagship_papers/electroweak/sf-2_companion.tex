...
\item[\textbf{DI-bit (Digital Information bit)}] The discrete information packet exchanged between CPs during the Perceive-Compute-Displace (PCD) cycle. DI-bits are conserved at the substrate level and propagate the SSV field across the lattice.
