...
%
% Version 1.2 -- 14 May 2026 (Session 83 -- incorporation of Thomas's
%   actual GPU numerical results from the two Companion Python programs.
%   The DP-chain MC ran with output (qDP: 40.3%, hDP-A: 29.7%, hDP-B:
%   29.6%, eDP: 0.4%) qualitatively validating the framework with
%   refinement on eDP rarity. The oblique-parameter scaling heuristic
%   ran with output (Delta T = 0.0001 within 3-sigma, Delta S = -0.754
%   and Delta U = 0.348 outside 3-sigma at heuristic placeholders) --
%   the Delta T near-zero result confirms the mass-degeneracy
%   prediction; the Delta S/Delta U placeholder values are not a
%   falsification per the rigor positioning but emerge as a substantive
%   constraint on what the eventual continuum-EFT derivation must
%   achieve (Pi_33 ~ Pi_3Q and Pi_11 ~ Pi_33 cancellations from D_6
%   symmetry). Patch 0364.)
%
% v1.1 history (Patch 0363, Session 83):
