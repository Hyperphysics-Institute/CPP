...
\midrule
$\Delta T$ & $0.0001 \pm 0.0000$ & $[-0.15, 0.21]$ & \textbf{WITHIN 3$\sigma$} ✓ \\
...
\item \textbf{For $|\Delta T| < 0.21$}: $m_{W^0} \approx m_{W^{\pm}}$ --- \emph{already delivered} by the W$^0$ framework's structural mass-degeneracy prediction. ✓
\end{enumerate}
