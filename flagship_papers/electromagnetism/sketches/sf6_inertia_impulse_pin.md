...
Residual constant-velocity drag at hold: **2.9% of peak back-reaction** (Galilean compliance in-model; the residual is the time-staggering floor of the integrator). Convergence at σ = 2.5: FFT ratio 0.9652 → 0.9893 from below, Momentwise ratio 1.0513 → 1.0200 from above — **both converge on (2/3)U/c²**. The residual deviation at σ ~ h is the substrate's genuine discreteness correction to inertia, not numerical error.
