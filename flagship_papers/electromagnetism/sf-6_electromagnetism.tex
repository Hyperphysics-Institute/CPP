...
% ------------------------------------------------------------
% CHANGELOG (canonical filename fixed; versions tracked here):
%   v0.1  Patch 1600  First .tex assembly to the 16-section apex standard
%                     (spine: c06 + DP-Sea-Polarization-Model + SR-1 + QM + EW-1).
%   v0.2  Patch 1602  OPEN-FP-6-EMHAND re-scoped (substrate manifestation (iii)
%                     closed; EM-phenomenology expression owed); TP-1 consistency.
%   v0.3  Patch 1606  Review cycle 1 restate (4-reviewer panel): E=hbar nu_C
%                     relabeled as a substrate-level IDENTIFICATION / ontological
%                     reduction (not a derivation); Michelson-Morley named as a
%                     flagship-level open falsifier; two-tier honesty calibrations.
%   v1.0  Patch 1607  ChatGPT v0.3 confirm pass clean (no verdict-flipping
%                     objections; panel unanimous on advance). Two final wording
%                     edits (PLS 'solid'->'companion-grade core identification';
%                     'candidate escape'->'unproven research direction'). SHIPPED.
% ============================================================
...
{\Large \textbf{Version 1.0 --- 21 June 2026}}}
