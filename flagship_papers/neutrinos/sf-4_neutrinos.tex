...
{\normalsize Version 0.3 --- 9 May 2026 (\S5 K3-Cage-Shell Consistency Theorem filled to full draft quality from \texttt{sketches/SF-4\_k3\_cage\_shell\_consistency.md}; foundation \S0--\S3 and \S4 unchanged from v0.2; \S6--\S11 unchanged from v0.1)}}
