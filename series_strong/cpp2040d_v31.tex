...
\begin{figure}[H]
\centering
\includesvg[width=0.90\textwidth]{figures/qm2040d_fig1_decoherence}
...
\begin{figure}[H]
\centering
\includesvg[width=0.90\textwidth]{figures/qm2040d_fig2_pointer_basis}
...
\bibitem{abshier2026c6}
T.~L. Abshier, ``The Dipole Sea and its Properties,''
companion~C6, Hyperphysics Institute (2026).
...
\textit{Found.\ Phys.} \textbf{1}, 69 (1970).
...
\bibitem{joos2003}
E.~Joos \textit{et al.},
\textit{Decoherence and the Appearance of a Classical World},
Springer (2003).
