...
\begin{figure}[H]
\centering
\includesvg[width=0.90\textwidth]{figures/qm2040c_fig1_nexus_singlet}
...
\begin{figure}[H]
\centering
\includesvg[width=0.90\textwidth]{figures/qm2040c_fig2_chsh_correlations}
...
\bibitem{abshier2026c4}
T.~L. Abshier, ``Inertial Mass from Zitterbewegung,''
companion~C4, Hyperphysics Institute (2026).
...
\bibitem{hensen2015}
B.~Hensen \textit{et al.}, ``Loophole-free Bell inequality violation,''
