...
The Strong Sector series derives QCD structure from the 600-cell tetrahedral geometry. SU(3) emerges uniquely from the 3-vertex cage base. Nucleon properties are derived from lattice-scale grounding.
...
- OPEN-SS-5: String tension σ from dimensional analysis
- OPEN-SS-1: Quark mass formula from ZBW-frequency kernel
