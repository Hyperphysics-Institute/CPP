...
The Strong Sector series derives QCD structure from the 600-cell tetrahedral geometry. SU(3) emerges uniquely from the 3-vertex cage base. Nucleon properties are derived from lattice-scale grounding. Light- and medium-nuclei binding energies follow from a single $K_3$ collective-mode quantum $B_\text{pair} = M_0/\varphi = 2.342$ MeV that recurs without rescaling at three physical scales: nucleon-pair (SS-5), alpha-alpha contact (SS-7), and interstitial-alpha contact (SS-8) — see `axiom-registry.md` Pattern 6.

---

## Papers

| ID | Title | Version | Key Result | Status |
|----|-------|---------|------------|--------|
...
| **SS-5** | Light-Nuclei Binding Energies from the Open-Vertex Cascade | v6 | $B_d, B_{^3H}, B_{^3He}, B_{^4He}$ all $\leq 5.3\%$ zero-param; $^5$He/$^5$Li/$^8$Be unbound ✓ | OSF pending |
...
| ID | Title |
|----|-------|
| SS-1a | Cage Geometry and Eigenvalue Bridge |
| SS-1b | SU(3) Algebra Exact Proof |
...
The light-nuclei (SS-5) → alpha-cluster (SS-7) → interstitial-neutron (SS-8) sequence is a structural cascade: each paper reuses the K₃ collective-mode quantum $B_\text{pair} = 2.342$ MeV at a successively coarser physical scale. The same quantum derived from SS-5's $K_3$-eigenvalue calculation appears unrescaled in SS-7's per-edge alpha-alpha binding and in SS-8's per-vertex interstitial coordination, providing three independent empirical tests of the same axiom-derived constant.
...
| ID | Name | Paper |
|----|------|-------|
| THEO-SS-1 | SU(3) from tetrahedral hopping | SS-1 |
| THEO-SS-2 | Gluon masslessness | SS-1 |
| THEO-SS-3 | β₀ = 7 | SS-1 |
| THEO-SS-4 | α_geom exact | SS-1 |
| THEO-SS-5 | k_SM derived | SS-1 |
| THEO-SS-6 | sea_strength derived | SS-1 |
| THEO-SS-7 | GMO mass formula | SS-1 |
| THEO-SS-8 | Decuplet equal spacing | SS-1 |
| THEO-SS-9 | Quark mass strict ordering | SS-1 |
...
- **SS-1:** mechanism, glossary, phenomena, reviews, FAQ, philosophy, development, keywords (8 files)
- **SS-2:** mechanism, glossary, phenomena, philosophy, development, reviews, keywords (7 files)
- **SS-3:** mechanism, glossary, phenomena, philosophy, development, reviews, keywords, FAQ (8 files)
- **SS-4:** documentation suite pending
- **SS-5:** mechanism, glossary, phenomena, philosophy, keywords, development, reviews + transcript (8 files at v6 currency)
