...
{\normalsize Version 1.3, 15 April 2026}}
...
generate~$\su(3)$ necessarily.  The $C_3$ rotational
...
Lie algebra of the tetrahedral cage.  The tetrahedral geometry
fixes the operator structure up to basis rotations --- the algebra
itself is invariant.  The proof is elementary linear
...
so its only proper subalgebras have dimension $\leq 3$
(isomorphic to $\su(2)$, $\mathfrak{u}(1)$, or their sums).  An alternative set of
