...
\begin{description}
  \item[\texttt{CONJ-SS-12}] \hfill \\ A structural conjecture relating nuclear binding to Euler's formula for simplicial polytopes.
  ...
  \item[\texttt{PH-OPEN-SS-22}] \hfill \\ The problem history of a retired open problem whose empirical anchor proved to be an isotope-selection artifact.
  \item[\texttt{PRED-O-16}] \hfill \\ The registered prediction extending alpha-chain results to a single larger cluster.
  \item[\texttt{PRED-O-17}] \hfill \\ The registered prediction for the transition between single and hierarchical alpha-chain regimes.
  \item[\texttt{PRED-O-18}] \hfill \\ The registered prediction for hierarchical slip-plane additivity.
\end{description}
