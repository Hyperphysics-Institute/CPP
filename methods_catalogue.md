...
**Cross-paper usage**: Used at chirality continuum joint paper §3.1, §3.2 (validity verification across three sectors), §3.3 (continuum-limit projection setup), §3.4 (Lemma 3.1), §3.5 (Theorem 3.2), §3.7 (Theorem 3.3), §3.8 (Theorem 3.4 = THEO-CHIR-CONT-1).
...
**Cross-paper usage**: Used at chirality continuum joint paper §3.3, §3.4 (Lemma 3.1 inherits equivariance), §3.5 (Theorem 3.2 uses $\Phi_*\hat{C}^{\text{sector}}$), §3.7 (Theorem 3.3 uses $\Phi$ for topological projection), §3.8 (Theorem 3.4 = THEO-CHIR-CONT-1). Sub-statements THEO-CHIR-CONT-1.1, -1.2, -1.3 all inherit from METH-CHIR-CONT-2.
...
**Cross-paper usage**: Used at chirality continuum joint paper §3.6 (definition introduction), §3.7 (Theorem 3.3 magnitude inheritance argument), §3.8 (Theorem 3.4 = THEO-CHIR-CONT-1). Anticipated future use: any CPP closure that needs to argue a substrate-level dimensionless quantity is preserved under continuum-limit projection.
...
**Cross-paper usage**: Used at chirality continuum joint paper §3.7 (Theorem 3.3 statement + proof), §3.8 (Theorem 3.4 = THEO-CHIR-CONT-1 condition (1) magnitude inheritance), §4 (Sector A V--A coupling derivation inherits magnitude $\chi/6$ at observable scale via this argument), §5 (Sector B chiral-polarity-bias derivation inherits magnitude $\chi/6$ at observable scale via this argument). Anticipated future use: any CPP Layer 4 closure that needs to argue a substrate-handle magnitude propagates through continuum-limit projection without renormalization.
