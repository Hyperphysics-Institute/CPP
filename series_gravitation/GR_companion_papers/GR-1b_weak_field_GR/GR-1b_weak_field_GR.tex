...
\item[DI-bit (Distributed Information):] The predecessor broadcast
  ...
  $\SSV_{\rm net} = \mathbf{E}+\mathbf{S}$ and computes
...
$\mathbf{e}_k\cdot\mathbf{\SSV}_{\rm net}$
...
per the local $\SSV_{\rm net}$ the next.  The identification
...
$k(\SSV_{\rm net})_\phi = GJ\sin^2\theta/(c^2r^3)$ gives the
