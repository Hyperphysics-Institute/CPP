...
orders); they do not discriminate CPP from GR.  Frame-dragging
...
exactly Schwarzschild, CPP has $\gamma = 1$ identically, and
\eqref{eq:shapiro} at the quoted leading-log precision is the honest
statement of this paper's claim.
...
wavefronts advance slower on the sun-side, turning the ray.  Exactly
