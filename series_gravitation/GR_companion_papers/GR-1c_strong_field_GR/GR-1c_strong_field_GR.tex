...
Grid Point'').  That rule was retired by the founder before this
paper's repository version (ruling R-EXCL-RETIRED, 31~August--1
September 2026; \texttt{axiom-registry.md} \S``Retired rules''); its
cited source, the Absolute Moment companion~\cite{c1}, has never
contained it in any repository version.  The proof's reading of $\lP$
