...
**Patch 3657, Session 164, 7 Sep 2026.** Verify `code/3657_kerrwall1_sn_local_wave_dictionary_verify.py` (13/13; run from the repo root — exec's 3359's SN machinery as 3619/3644 do; ~10 min). Reasoning `reasoning/3657.md`. No paper touched. CONV-042 held. Ledger `3641_triangulation_ledger.md` row 7 and §5 updated.
...
- `Y = X/√η` obeys `Y'' = W Y`, `W = U + F²/4 + F′/2` (Schrödinger form: Y is the local wave of the SN family);
