...
*Dated correction (3670): §3's "more reflective than the a = 0 step (0.77 vs 0.53)" and §5's "the a = 0 horizon is a real step 0.53 at −3°" inherit 3657 §4's mixed-frequency error — at real ω the a = 0 horizon from 8M/3 reflects Z⁺ at 0.39, −43°; the Kerr numbers here are real-ω readings, and the requirement is stated at the complex poles, where Im β_hor > 0 in the even variable at χ = 0.68 (3670 §4). The verdict of this note is unchanged.*
