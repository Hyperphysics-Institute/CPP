...
\medskip\noindent
\textbf{Keywords:} Z boson, neutral current, icosahedral ring, mass ratio, loop density, electroweak precision, LEP measurements, CPP electroweak

\bigskip\noindent
\textbf{Plain Language Summary:}
The Z boson, which mediates neutral-current weak interactions, is modelled in CPP as a closed icosahedral ring of heavy Dipole Pairs on the 600-cell lattice. Unlike the open bracelet of the W, the Z's closed ring has full icosahedral symmetry, explaining its zero charge and higher mass.
...
\cite{cpp_ew2}, with the geometric factor enhanced by $\ell_Z$:
\begin{equation}
f_{\rm geom}^Z
