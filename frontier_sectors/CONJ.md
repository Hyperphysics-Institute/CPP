...
- Step 3 — coldness (velocity dispersion at decoupling). Step 4 — power spectrum from "swirl" seeds. Step 5 — quantitative halo/rotation curve (ρ∝1/r² or NFW). **[Step 3 — Patch 0706, DONE: SURVIVES (cold by a wide margin) — qDP/hTetra at ~0.3–1.5 GeV are ~10⁵–10⁶× above the ~3 keV warm-DM bound, non-relativistic since the QCD era, v/c~10⁻⁴–10⁻⁵ by matter-radiation equality; rests only on the GeV mass scale, not on OPEN-SR-5. Steps 4 & 5 are GATED on OPEN-SR-5 (power spectrum needs expansion dynamics; rotation curve needs the cosmological-scale Sea-gravitation force law). See `series_phenomena/cosmology/dark_matter/step3_coldness.md`. ARC STATUS: all three OPEN-SR-5-independent gates computed, none kills — natural pause point; recommend a new OPEN-SR-5 cosmological-sector arc rather than further DM-side estimation.]**
