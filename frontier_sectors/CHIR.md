...
and the symmetric-bias form assumption (CHI-1 F2). (The E19/E20 merge — whether `σ_cycle = sign(n̂)`
— is RESOLVED: M1-χ, one currently-identified chirality primitive FI-C-9, THEO-CHIR-MERGE-2.)
