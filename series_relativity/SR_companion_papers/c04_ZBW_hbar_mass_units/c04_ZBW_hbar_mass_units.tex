...
carrier per R-ARC-CANCEL-TURNAROUND, Patch 3134; mathematics untouched)}}
...
\emph{[Scope of this claim (Version~2.1, Patch 3202, F-SW-10 R-2.3 fix pass).
...
R-ARC-CANCEL-TURNAROUND (Patch 3134) the carrier is the dressed pair's
\emph{stored DP arc field}: the pair's two arc stores have opposite rotation
senses and cancel at co-location, zeroing the inertia-associated
$\mathrm{SSV}_{\rm net}$ --- the necessary condition for stop and turnaround,
since surviving inertia would carry the CPs through to a far-side turnaround.
The two statements are complementary, not competing: the resonance sets how
much inertia there is, the arc store is the thing whose removal releases it.]}
