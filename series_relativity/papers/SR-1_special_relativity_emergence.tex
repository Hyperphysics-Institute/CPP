...
{\normalsize Version 20, 15 July 2026}}
...
see the diagnosis subsection above). Appendix~F and the Casimir $(l_P/d)^4$ scaling of
Appendix~E are accordingly retained as internal algebra only, \emph{not} as candidate
predictions --- permanently so within the pinned mechanism, not merely pending a
derivation. Consequently the withdrawn Unruh mode-counting Monte-Carlo claim is
