...
**Trigger to close:** Item 2 patch applied + Item 3 ruled + the queue regenerated showing the GR-series rows under new identities. Cross-references: `series_relativity/audits/3225_gr1_scoping_assessment.md` §8; Session 148 handover §5; `series_gravitation/README.md`; `frontier_sectors/GR.md`.
