...
| 1.5 | `bootup.md` **§0.5** | **STANDING WORKER DISCIPLINE** — ten process rules, each with its recorded cost. Read before doing any work. | 3 min | **All of it.** Handovers are superseded every session; durable process rules live HERE, not in a handover. |
...
number, spend one `grep` on the thing it names. Ten failures above, and in every case a
