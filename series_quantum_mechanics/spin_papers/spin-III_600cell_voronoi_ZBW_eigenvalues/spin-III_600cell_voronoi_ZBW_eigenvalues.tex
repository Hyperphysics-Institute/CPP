...
\label{eq:mult}
\end{equation}
Since the full symmetry of the cell is $I_h = I \times \{1, -1\}$ and
the boundary function is even, odd-$l$ content vanishes identically.
...
\begin{equation}
k_{6,1}R = 8.211 \;>\; \tfrac{3\pi}{2} = 4.712 = k_2 R,
\end{equation}
a $74\%$ margin.  Hence the second invariant mode of the true cell
...
so it picks out only the $l = 0$ mean --- a pure scale change that
...
instrument's own declared approximation enters at the same order.)
