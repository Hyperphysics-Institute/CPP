...
{\large QM Series --- Paper 2 (Version 2.8)}}
...
this paper's standing — OPEN-QMRG-ETA ($\eta$'s lattice derivation --- mode-independence
DERIVED at bookkeeping grade, Patch 3009; open at reduced scope,
the geometric constant $c_{\rm geo}$ only),
OPEN-QMRG-UNIQ, and watch condition W-MULTILINK-1; citation-note
requirements persist only for the E-2 note classes:
$\eta$-universality, physical $\rho$-calibrated normalization,
uniqueness, universal-microscopic claims)}. Interim statuses as of
...
$\rho$-calibrated amplitude claims remain barred pending $\eta$'s
lattice derivation. The QM-1$\leftrightarrow$QM-5
