...
{\large QM Series --- Paper 2 (Version 2.1)}}
...
linear-response regime.  Registered obligations: \textbf{OPEN-QMRG-B1}
--- B-QMRG-1 must be derived from substrate dynamics (locus: Paper~6
or a dedicated coherent-mode bridge arc) before any grade elevation
of this Proposition or of the Born-rule reconciliation; until then,
neither this paper nor Paper~6 may be cited as support for the
amplitude--count relation (mutual-support prohibition).
\textbf{R-4} --- plane stability: prove the GP refresh preserves the
...
including stationary states (severity: medium--high).  The theorem of
