...
{\large QM Series --- Paper 2 (Version 2.11)}}
...
$\eta$-universality, uniqueness, universal-microscopic claims ---
the physical $\rho$-calibrated-normalization note class was
DISCHARGED at bookkeeping grade, CONV-013 AUX-3 (3/5), recorded
Patch 3037 with the exact grade-fenced wording and calibration
provenance note (`aux3_rho_calibration_discharge_record.md`,
`rho_calibration_provenance_note.md`))}. Interim statuses as of
