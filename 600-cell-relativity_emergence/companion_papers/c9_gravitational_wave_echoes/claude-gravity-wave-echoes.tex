...
The present companion provides that derivation.  Section~\ref{sec:mechanism}
reviews the Planck-core structure from companion~8.
...
%======================================================================
\section{The Planck Core as a Reflective Boundary}
\label{sec:mechanism}
%======================================================================
...
The echo delay formula was derived in collaboration with Grok (xAI).
The author thanks Claude (Anthropic) for mathematical formulation,
numerical verification, and LaTeX preparation.
