...
**Purpose:** Track high-leverage moves that have been identified but deferred to keep individual sessions focused. Updated 2 May 2026 Session 5 Phase 1 (AME 2020 lookup completed, queue item B removed; OPEN-SS-35 attempt remains the active item).
...
*Priority:* HIGH (largest cross-paradigm consilience target the programme has identified). *Scope:* Multi-session, possibly multi-paper. *Trigger:* OPEN-SS-34 Level-1 derivation (2 May 2026 third sub-arc) identified H3 (shell-magic numbers $Z, N \in \{2, 8, 20, 28, 50, 82, 126\}$) as the load-bearing dependency. **Leverage doubled by 4th sub-arc:** OPEN-SS-36 closure also depends on OPEN-SS-35 (per 4th sub-arc retirement of constant-$\sqrt{3}$ in favor of closure+shell decomposition where $B_{\rm shell}$ requires CPP shell-magic derivation). Closure unlocks both OPEN-SS-34 and OPEN-SS-36 simultaneously. **Empirically reinforced by Session 5 Phase 1:** the per-nucleus $B_{\rm slip}$ sequence accelerates sharply approaching ${}^{100}$Sn ($1.94 \, B_{\rm pair}$ at ${}^{88}$Ru → $2.11$ at ${}^{92}$Pd → $2.80$ at ${}^{96}$Cd → $3.28$ at ${}^{100}$Sn), confirming shell-closure-influence concentrated at the doubly-magic point. *Best lead at registration:* CPP analog of spin-orbit coupling from 600-cell coordination + ZBW phase structure. Pattern-6 K$_3$ scale-recurrence at the nucleon-shell-organization scale. *Registered:* 2 May 2026 Session 4 follow-up 3rd sub-arc, OPEN-SS-35 entry in `Research_Frontier.md`. *Companion:* `series_strong/papers/SS-9/sketches/SS-9_OPEN-SS-34_derivation_attempt.md` §8.
