...
Done at 4222 (`code/4222_critic_*.py`): **4193 CONFIRMED** (table by selection); **4216 CONFIRMED** (sign from couplings + Dzuba–Flambaum / Sahoo forms matched across γ₅ conventions; my own first draft had the L_eff sign wrong and would have withdrawn a sound result — recorded); **4206 §2 DOWNGRADED** — a = −1/3 is a structural match, A = −2/3 and B = +2/3 match only because the SU(6) per-quark polarisation 2/3 equals the J=½ Clebsch factor 2/3 (no shared input; the SM at the SU(6) point gives A = −0.238). **Owed, deferred:** (i) critic on 4192's coherent-mixing exclusion — see [[TODO-4192-COHERENT]], still open; (ii) critic on 4219/4220 (which spins persist; item 4 reverted) — not started; (iii) 4215's open question, (1−β) or (1−β²) for the e/μ ratio — **DECIDED at 4249: (1−β); with the 2E_l·2E_ν normalisation the model equals the SM tree ratio exactly; the 0.70 was the omitted normalisation.** SF-2 v1.06's postdiction sentence carrying the 4206 wording: **replaced at 4223** (v1.07). **Lane: EW.**
