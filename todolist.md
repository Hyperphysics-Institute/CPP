...
- **Chirality lane — nothing blocking.** The lane's own oldest debt is unchanged: OPEN-FP-F1-2 L4-D (Mechanism A's sign gate), which keeps V3/W3 conditional (`frontier_sectors/FP.md`). Next chirality work item unless the founder redirects.
