...
**STEP 3 REMAINS OWED, and the argument is incomplete without it:** the W bracelet's D6 ring must be treated on the same footing and shown to be handed where the cage is not — the corpus answer being that the bracelet reads the *incoming free particle's* bit (4097), not one of its own. Until step 3 is run, the 4134 result does not distinguish the two cases and risks proving too much. Run on the real bracelet, not a generic ring. **Lane: EW/SS.**
