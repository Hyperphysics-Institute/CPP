...
### TODO-4174-VECTORGW — **A_i propagates, so it should radiate a VECTOR gravitational-wave mode — and those are bounded** (registered Patch 4174, EW/GR lane — the channel's first real empirical handle)
