...
### TODO-4264-PASSTHROUGH — ZBW pass-through (founder proposal, PENDING RULING)
Founder proposal (`founders_voice/4264_proposal_zbw_is_pass_through_shm.md`): ZBW is a conservative pass-through oscillation, not superposition-stop-reverse; would supersede R-ARC-CANCEL-TURNAROUND (3134 §3). Assessment: `series_standard_model/axiom_maturation/4264_zbw_pass_through_assessment.md` (recommend adoption on energy conservation and 3134's own asymmetric-pair logic). **Awaiting the founder's ruling (axiom-level).** On adoption, sweep campaign (4264 §4 table): (1) supersession banner on 3134 §3; (2) c04 v2.1 scope banner rewrite (mathematics untouched); (3) re-sweep F-SW-10 R-2/R-5 (3201, 3203) against the new ruling; (4) sea-gravitation R-DWELL-1: dwell kept as one-Moment co-location, relaunch term re-derived as carried-through momentum, σ_n decomposition re-checked (sigma_n_derivation.md, darcforce_*, selfconsist_*, scripts 3078–3131); (5) EW 4231/4232 reset mechanism restated as transit (cf. founder 4240 passage by inertia); (6) DM 2454/2455/conv001: check whether ring survival used the stop; (7) read QM-1/2/6, SPIN-1, GR-1j reset/turnaround/dwell wording. **Independent of the ruling, owed:** route (C) coupling under integer CP charges (4263) — SS-2's colour coefficients no longer apply; derive a from the founder's charge picture and re-run 4264's pass-through rows, EW → strong.
