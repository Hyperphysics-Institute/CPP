...
\textbf{(vi) Grade.} Layer-C consistency, now carrying \textbf{two explicit derivation debts as promotion gates: the $m_s = \chi\,(\hbar c/r_c)$ gap and the first-multipole coupling order.} The halo-sector results of v1.2 (dwarf pin, LSB, cluster ladder, Bullet, group falsifier) are untouched by this notice. \textbf{Status: v1.3-DRAFT --- not shipped; panel re-review required; OSF release held.} The v1.2 notice below is retained per house discipline, with its item (ii) superseded as stated.
\end{mdframed}
