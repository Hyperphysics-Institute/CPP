...
region --- \emph{conditional on the pending rate computation demonstrating
visibility below the strongly-interacting overburden ceiling}: until that
computation lands, this is a registered conditional falsifier, not a presently
executable exclusion); (c) Clause 1's four founder-attested exits (Patch 2358; frames and
