...
\textbf{REVISION NOTICE (v1.4-DRAFT, 6 July 2026) --- methodology and the substrate inversion: the measured-coefficient (CONV-004) framing supersedes the v1.3 ``derivation-debt'' governance language, and the first data-drawn portrait of the DP Sea enters the record; covers the governance items of the v1.3 notice below and adds \S(ii)--(iii). Campaign record: \texttt{OPEN-SS-43\_Rs\_derivation.md} \S\S25--27; \texttt{SI-1\_unknowns\_and\_forward\_maps.md}; reasoning/code 1886--1888; founder ruling verbatim in \texttt{founders\_voice/founder\_ruling\_measured\_coefficients\_2026-07-06.md}. DRAFT --- short CONV-001 re-look required (a panel-ratified governance sentence changes).}
