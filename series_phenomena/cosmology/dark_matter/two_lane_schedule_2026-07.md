...
| B4 | Adjudicate red-team returns as they arrive (each KILL/WOUND gets a computation-level response in `red_team_adjudications_2026-07.md`; errata queue updated; a confirmed KILL pauses per plan §Release gates) | Worker (founder pastes returns) | any session incl. RELEASE SESSION | plan item 1 completion; release gate assessed on the received set |
