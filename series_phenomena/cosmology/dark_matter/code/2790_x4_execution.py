#!/usr/bin/env python3
"""X4 LADDER EXECUTION under the FROZEN 2786 prereg SS2 + PA-1 (2788).
...
RUNS={"X4-02-686":(686,0.02,20260805,600,2400),"X4-02-1024":(1024,0.02,20260806,600,2400),
      "X4-01-432A":(432,0.01,20260807,400,1600),"X4-01-432B":(432,0.01,20260808,400,1600),
      "X4-01-686":(686,0.01,20260809,600,2400),"X4-01-1024":(1024,0.01,20260810,600,2400),
      "X4-005-432A":(432,0.005,20260811,400,1600),"X4-005-432B":(432,0.005,20260812,400,1600),
      "X4-005-686":(686,0.005,20260813,600,2400),"X4-005-1024":(1024,0.005,20260814,600,2400)}
...
def gate_v2(only=None):
    ...
    for label in ([only] if only else list(RUNS)):
...
if __name__=="__main__":
    cmd=sys.argv[1]
    if cmd=="gate": gate_v2(sys.argv[2] if len(sys.argv)>2 else None)
