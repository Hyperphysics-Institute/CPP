...
- **L4-b (pin-velocity audit): PROMOTED to required next computation** (5/5 seats) — decides the strand statement's final form; the G3 collision claim is conditional on it (s_req 17 at v_pin=50 → 3.11 at 60, grazing the family max 3.2 from below).
