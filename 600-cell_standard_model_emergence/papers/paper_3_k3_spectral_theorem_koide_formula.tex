...
% VERSION 2 — revised after Opus review (24 March 2026)
%
% v1→v2 changes:
...
of the tetrahedral cage), given three physically motivated postulates.
The three postulates are: (P1)~the ZBW Hamiltonian is proportional to
the $K_3$ adjacency matrix; (P2)~lepton mass is proportional to squared
ZBW amplitude; (P3)~the $K_3$ eigenstates are thermally equipopulated
...
The Koide formula is an empirical constraint satisfied by
...
\begin{postulate}[$\ZBW$ Born Rule, P2]
\label{post:Born}
...
P2: $m_i \propto |\psi_i|^2$ & Open (OP-SM-7b) & Lepton-sector Born rule \\
