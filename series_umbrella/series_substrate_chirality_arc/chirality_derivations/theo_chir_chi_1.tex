...
\title{\textbf{The Substrate Chirality Magnitude $\chi = \varphi^{-3}$ as the\\
Locality-Selected Symmetric Bias of the 600-Cell's Two Nearest Shells}\\[6pt]
\large A Layer-2/2.5 structural-selection theorem (THEO-CHIR-CHI-1)}
