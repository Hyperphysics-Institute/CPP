...
\title{\textbf{Deriving the PCD Winding Orientation from the Chirality Director:\\
the $\nhat \mapsto \wPCD$ Link as a Chirality-Classification Theorem}\\[6pt]
\large A viability-level primitive-count resolution (THEO-CHIR-PCD-ORIENTATION-1)}
