...
\paragraph{9-shell vertex classification.}
At $k=3$, path endpoints $v''$ can reach beyond the 4 inner shells that
suffice at $k\leq 2$. The full 9-shell classification by $\langle v'',
\vhost\rangle$ is:
\begin{center}
\begin{tabular}{l c r}
\toprule
