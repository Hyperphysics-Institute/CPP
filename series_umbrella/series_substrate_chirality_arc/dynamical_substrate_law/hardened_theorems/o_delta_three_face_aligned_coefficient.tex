...
\begin{theorem}[parity-dependent algebraic structure]\label{thm:parity-structure}
...
incident faces $\{\ui, \uj\}$ at $\vhost$: choosing a different face rotates
$\nperpF$ within $T_{\vhost}S^3$ but leaves the $V_4$-invariant subspace
$\mathrm{span}\{\nrho, \nax\}$ and the projected coefficients unchanged. The
verify script confirms this explicitly: across all 30 faces, the standard
