...
| SD (1-5) | 5 | ✅ | ✅ | ✅ | ✅ | ✅ |
| **SF-line (flagship)** | **4 SHIPPED (SF-2, SF-3, SF-4, Capotauro) + 4 future (SF-1, SF-5, SF-6, SF-7)** | **✅ for SHIPPED** | **✅ for SHIPPED** | **partial (SF-4 v1.0-v4.4 full suite; SF-3 v1.0 full 7A suite + anthology; SF-2 v1.0 4-tier in progress; Capotauro v1.0 4-tier in progress)** | **✅** | **partial** |
