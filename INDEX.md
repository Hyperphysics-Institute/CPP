...
| [`neutrinos/`](flagship_papers/neutrinos/) | **SF-4 [ACTIVE — v0.1 SHIPPED]** — Neutrino Sector Unification from 600-Cell Geometry; v0.1 .tex shipped Session 45 patch 0305 with foundation sections at full quality and derivation/closing sections as substantive stubs; v0.2-v0.5 iterations fill stubs from established sub-derivations |
| [`neutrinos/sf-4_neutrinos.tex`](flagship_papers/neutrinos/sf-4_neutrinos.tex) | **SF-4 v1.0 SHIPPED (Session 54, patch 0314)**: 1850+ lines source; partial-closure flagship neutrino-sector paper SHIPPED on five-pass AI review convergence (ChatGPT × 3 + Grok × 1 + Copilot × 1) |
| [`neutrinos/sf-4_neutrinos.pdf`](flagship_papers/neutrinos/sf-4_neutrinos.pdf) | **SF-4 v1.0 SHIPPED compiled PDF (Session 54, patch 0314)**: 40 pages, 537 KB |
| [`neutrinos/documentation_suite/`](flagship_papers/neutrinos/documentation_suite/) | **SF-4 four-tier documentation suite at v1.0 freeze**: handover-SF-4 + development-SF-4 + transcript-SF-4 + reasoning-SF-4 |
...
| [`neutrinos/sketches/`](flagship_papers/neutrinos/sketches/) | SF-4 staging documents. Currently: `SF-4_neutrino_sector_audit.md`, `SF-4_mechanism_selected.md`, `SF-4_suppression_derivation.md` (OPEN-FP-SF-4-1 PARTIAL CLOSURE), `SF-4_k3_cage_shell_consistency.md` (OPEN-FP-SF-4-2 PARTIAL CLOSURE at SM-5-inheritance level) |
