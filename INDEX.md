...
Papers SM-1 through SM-6. **All 6 papers registered on OSF.**
...
| `SM-6_lepton_mass_spectrum.tex/.pdf` | **SM-6** | v3 | Registered (2 Apr 2026) |

**Documentation per paper:** `development-SM-N.md`, `glossary-SM-N.md`, `mechanism-SM-N.md`, `phenomena-SM-N.md`, `philosophy-SM-N.md`, `reviews-SM-N.md`, `FAQ-SM-N.md`, `keywords-SM-N.md` — 8 files × 6 papers = 48 files.
