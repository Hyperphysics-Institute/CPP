...
| [`neutrinos/sf-4_neutrinos.tex`](flagship_papers/neutrinos/sf-4_neutrinos.tex) | **SF-4 v0.9 paper draft (Session 53, patch 0313)**: ChatGPT review pass 3 corrections incorporated; 1850 lines source; **v1.0-promotion-ready** per reviewer's forward-looking assessment |
| [`neutrinos/sf-4_neutrinos.pdf`](flagship_papers/neutrinos/sf-4_neutrinos.pdf) | **SF-4 v0.9 compiled PDF (Session 53, patch 0313)**: 40 pages, 536 KB; v1.0 SHIP next session if no new issues |
