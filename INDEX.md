...
| [`neutrinos/`](flagship_papers/neutrinos/) | **SF-4 [ACTIVE]** — Neutrino Sector Unification from 600-Cell Geometry; audit complete (Session 37); mechanism selected (Session 39) — Candidate C with $\alpha=2$ and assignment (tet, ico, icosid); both substantive sub-problems at PARTIAL CLOSURE (Sessions 41, 43); **v0.1 outline established Session 44 — drafting begins Session 45+** |
| [`neutrinos/sf-4_outline.md`](flagship_papers/neutrinos/sf-4_outline.md) | SF-4 v0.1 outline document (Session 44, patch 0304): section-by-section structure, predictions table covering 7/8 zero-parameter neutrino parameters, falsifier set, source-material map, drafting plan |
