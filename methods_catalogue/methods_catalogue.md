...
**End of seed catalog.** Total entries: 7 Layer 1 (METH-L1-001 through METH-L1-007) + 8 Layer 2 (METH-L2-001 through METH-L2-008) + 4 Layer 3 (METH-L3-001, METH-L3-002, METH-L3-003, METH-L3-005) = **19 entries**. Numbering slots METH-L3-004 and METH-L3-006 vacated at Patch 0462 (organizational entries removed per the explicit physics-derivation-only scope of `README-methods_catalogue.md`); METH-L3-007 vacated at Patch 0461 (Patch 0460 protocol-pattern addition reverted as out-of-scope). All three vacated slots remain reserved per the naming-convention rule that numbers are not reused once assigned — future METH-L3-004, METH-L3-006, and METH-L3-007 entries must be *physics-scoped*. The METH-L2-007 and METH-L2-008 slots were refilled with physics-scoped entries at Patch 0464 from the Session 134 Tier-4 audit. Full catalog completion (back-fill from earlier closure arcs: SF-4, SS-9, SM-line, EW-line) queued as OPEN-ORG-016.
