...
types in equal abundances (ZBW Mass companion, \S3.1).  Within this cloud,
every DP contributes:
...
kinetic ZBW contributions alone, which is positive (compressive) in all
directions.  No polarity-dependent cancellation occurs.
\end{proof}
...
\section{Open Problems and Path to General Relativity}
\label{sec:GR}
