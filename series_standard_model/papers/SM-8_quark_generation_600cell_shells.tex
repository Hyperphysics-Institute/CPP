...
\begin{remark}[Spectral dimension hint]
A preliminary spectral-dimension analysis of the cage subgraph
(63 vertices comprising all four cage types around a single vertex)
yields $d_s \approx 2.40$ in the intermediate time window, numerically
close to the fitted exponent $\alpha = 2.38$ and to the algebraic
value $3 - 1/\phig \approx 2.382$.  This suggests a deeper geometric
origin for the scaling law, potentially tied to the golden-ratio
structure of the $H_4$ lattice.  A full derivation --- showing that
the 600-cell's symmetry forces $d_s = 3 - 1/\phig$ on the cage
...
\item A dynamical derivation of the scaling exponent $\alpha = 2.38$
  from the spectral geometry of the 600-cell (target of SM-9).
