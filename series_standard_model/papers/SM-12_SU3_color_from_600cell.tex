% ==================================================================
% Version note — 19 Aug 2026, Patch 3231: re-identified SM-12 (founder
% ruling: SM category, standalone paper, not a companion); moved from
% series_relativity/SR_companion_papers/c15 to
% series_standard_model/papers/. Complementarity note added (SS-1b/c).
...
Patch 3231).} The strong-sector series treats SU(3) from the cage side:
SS-1b proves the SU(3) algebra exactly, and SS-1c derives the eight
gluons from HDP structures. This paper obtains SU(3) colour from the
600-cell geometry by the complementary route. The results should be
read together as two structural levels of the same sector; neither
