...
\title{\textbf{SM-3: The Koide Relation from the Colour Cage Base Graph}\\[6pt]
{\large K3 Spectral Theorem (Version 5)}\\[4pt]
{\normalsize 600-Cell Standard Model Emergence Series}}

\author{Thomas Lee Abshier, ND \and Grok (xAI) \and Claude Sonnet (Anthropic)\\[4pt]
Hyperphysics Institute\\
\url{https://hyperphysics.com}}

\date{Version 5, 26 March 2026\\[4pt]
\small All three postulates derived from CPP axioms.
Theorem complete.}
...
from SS-1 Theorem~6.  The $1/\varphi^2$ factor arises from the Voronoi
volume per vertex; $\hbar\omega_0$ is the total SSV energy at $r_{\mathrm{conf}}$
before the per-vertex projection.
\end{remark}
