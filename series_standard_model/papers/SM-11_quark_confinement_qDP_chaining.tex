...
% Version 1.2 — 19 Aug 2026, Patch 3231: re-identified SM-11 (founder
%   ruling: SM category, standalone paper, not a companion); moved from
%   series_relativity/SR_companion_papers/c14 to
%   series_standard_model/papers/. Complementarity note added (SS-1d).
%   Header/prose modernization beyond that rides the next version bump.
% ==================================================================
...
\noindent\textbf{Complementarity note (added at re-identification,
Patch 3231).} The strong-sector series derives confinement and the
running coupling from the cage side: SS-1d obtains the confinement
mechanism and the beta function from 600-cell cage geometry. This paper
derives the confining Cornell potential from the complementary qDP
\emph{chaining} mechanism. The two routes address the same physics from
different CPP structural levels and should be read together; neither
