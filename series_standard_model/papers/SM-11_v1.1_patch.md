# SM-11 v1.1 Patch File

**Instructions for next Opus:** Open `SM-11_lattice_scale_nucleon_structure.tex` and apply these 11 changes in order. Each gives the OLD text to find and the NEW text to replace it with.
...
- [ ] Verify CONJ-SM-11-1 label appears in §4
