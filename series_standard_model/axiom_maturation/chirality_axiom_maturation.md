...
| **F3** | **CONDITIONAL — founder-endorsed (4097)** — **Founder ruling 18 Sep 2026 (verbatim at `founders_voice/4097_ruling_velocity_dp_arcs_not_intrinsic_to_cp.md`):** "the velocity of the particle is not something the CP carries intrinsically. The KE/momentum/inertia/velocity of a CP is carried by the DP arcs established during acceleration." Corpus: SF-6 Patch 3202 (DP-arc cohort carries KE); inertia sketch Patch 2496 (CP has no intrinsic KE — all in arcs). **Physical mechanism:** free particle has persistent DP arcs (→ b ≠ 0); confined quark has arcs continuously severed and re-established in all directions by cage (bremsstrahlung-like dissociation, SF-6) → ⟨b_from_arcs⟩ = 0 → strong force P-even. Same for EM sea DPs. **Capture criterion (4086) still failed; the free-vs-confined distinction is the correct basis.** Pending formal derivation. |
