...
| PRED-O-20 | Mid-region satellite-regime predictions at $^{92}$Pd ($N_\alpha = 23$) and $^{96}$Cd ($N_\alpha = 24$) [T3] (registered 2 May 2026 Session 4 follow-up second sub-arc as continuation of PRED-O-19 once $^{84}$Mo, $^{88}$Ru, and $^{100}$Sn anchors confirmed the satellite-regime / regime-termination structure) | $B(^{92}\text{Pd}) = 760.20$ MeV, $B(^{96}\text{Cd}) = 790.84$ MeV (same satellite formula as PRED-O-19; same calibrated $B_{\text{slip}}$). Predicted residuals against AME 2020 measurements should be $\lesssim 0.5$ MeV at both, consistent with the cumulative 9-nucleus fit (RMS $0.32$ MeV across $N_\alpha = 14$–$22$); residuals $> 1$ MeV would indicate that the satellite regime breaks down before reaching the doubly-magic termination at $^{100}$Sn | AME 2020 binding energies for $^{92}$Pd and $^{96}$Cd (currently $^\#$-extrapolated; pending direct measurement or careful verification against Thomas's local reference) vs the predicted 760.20 and 790.84 MeV | SS-9 sketch `SS-9_PRED-O-19_verification.md` §5, OPEN-SS-34 |
