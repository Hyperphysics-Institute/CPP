...
|---|---|---|---|
| **DM** (dark matter) | **3500–3599** | **ACTIVE** — opened at 3500; highest used 3509 (11 Sep 2026, OPEN-DM-PAIRING-KINETICS-1 charter 3508 and founder answers 3509, **both written from an EU-lane window under PD-006** — recorded per the 3426 precedent; next free 3510) | `frontier_sectors/DMDE.md` (DM section) |
