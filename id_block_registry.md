...
| **EU** (early universe / cosmology) | **3800–3899** | **ACTIVE** — opened at 3800 (**G-EU-BLOCK-3800**, founder ruling 8 Sep 2026: "Please use the 3800 series for EU"); first use Patch 3800 (this registration). The DE (3400s) and DM (3500s) blocks remain active and separate (founder, same ruling). Sector file: EU items live in `research_frontier.md` (OPEN-EU-*) until an `EU.md` sector file is warranted. **Session 208 (11 Sep): highest used 3899; next free — **EU BLOCK 3800–3899 IS NOW EXHAUSTED.** A new EU block must be allocated before the next EU patch. (Precedent: the 3600–3699 → 3800–3899 allocation.)** | `research_frontier.md` (OPEN-EU-*) |
