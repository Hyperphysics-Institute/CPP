...
**Status:** OPEN — scoping work begun, Level-0 consistency check passed (registered 2 May 2026 Session 4 follow-up 3rd sub-arc; **scoping document delivered 2 May 2026 Session 5 Phase 2** with Route A adoption + Level-0 consistency check passing + Route D ruled out by computation)
