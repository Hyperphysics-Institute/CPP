...
$b$ & $-1/3$ & 3 & $-$qCP; osc + tetrahedral + icosahedral + dodecahedral
  & $4.18$~GeV & $4.73$~GeV \\
$t$ & $+2/3$ & 4 & $+$qCP; all four cages (fourth cage structure open)
...
Top quark fourth cage (structure open)
  & Top quark: four nested cages; fourth cage not yet identified
    (C$_{60}$ fullerene ruled out as a 600-cell distance shell)
  & Future: cage structure observable in top-quark production? \\[4pt]
...
\bibitem{stiffness_c}
T.~L.~Abshier and Grok (xAI),
\textit{Special Relativity from 600-Cell Lattice Dynamics}, v17,
Hyperphysics Institute (2026).  Appendix~A.5 derives
$\alpha_{\rm geom} = 3(11+5\sqrt{5})\sqrt{5+\sqrt{5}}/320
\approx 0.55936$ from the H4 Voronoi stiffness integral and
establishes $k_{\rm rel} = \alpha_{\rm geom}\,l_P^3/E_P$.
Available: \texttt{CPP/600-cell-relativity\_emergence/} (GitHub).

\bibitem{cpp_sm_paper2}
T.~L.~Abshier and Grok (xAI),
\textit{Mass Generation from Symmetry Breaking in the 600-Cell Lattice:
A Semi-Empirical Approach}, Paper~2 v29,
CPP/600-cell\_standard\_model\_emergence/papers/ (2026).
Derives SM particle masses from $k_{\rm SM} = \alpha_{\rm geom}/(12\phig^2)$
with zero free parameters beyond one electron-mass calibration anchor.
