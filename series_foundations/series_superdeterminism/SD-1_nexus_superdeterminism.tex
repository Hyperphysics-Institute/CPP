...
\medskip\noindent
\textbf{Keywords:} superdeterminism, Bell theorem, Nexus constraint, hidden variables, quantum randomness, Planck-scale correlations, measurement independence, 600-cell lattice

\bigskip\noindent
\textbf{Plain Language Summary:}
Quantum mechanics appears random, but CPP says the randomness is an illusion. The Nexus --- a global consistency constraint of the 600-cell lattice --- correlates measurement settings with outcomes at the Planck scale. This is not a conspiracy; it is a mathematical consequence of the lattice topology. The correction to standard quantum predictions is about 10 to the minus 26 --- far too small to detect with current technology, but in principle measurable with future quantum processors.
