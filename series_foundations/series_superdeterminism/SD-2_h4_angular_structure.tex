...
\medskip\noindent
\textbf{Keywords:} H4 symmetry, angular correlations, cos(5 theta), Bell experiment, Nexus signature, 600-cell symmetry group, superdeterminism test

\bigskip\noindent
\textbf{Plain Language Summary:}
The Nexus correction to quantum predictions has a specific angular pattern determined by the H4 symmetry group of the 600-cell. This paper derives the cos(5 theta) angular signature that distinguishes CPP superdeterminism from standard quantum mechanics. The prediction has never been tested but could be checked with sufficiently precise Bell experiments.
