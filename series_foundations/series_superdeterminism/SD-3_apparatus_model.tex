...
\medskip\noindent
\textbf{Keywords:} apparatus model, decoherence timescale, measurement precision, quantum coherence trade-off, Nexus coupling, Planck-scale decoherence

\bigskip\noindent
\textbf{Plain Language Summary:}
Quantum measurements require apparatus, and the apparatus itself is made of 600-cell lattice matter. This paper derives a quantitative trade-off between measurement precision and quantum coherence: the more precisely you set a measurement angle, the more the Nexus correlates that setting with the outcome. The decoherence timescale is about 10 to the minus 39 seconds --- the apparatus decoheres almost instantly at the Planck scale.
