...
% Unified Submission Package — Version 1
% SS #1–5 synthesis
% arXiv-ready single document
% GitHub: CPP/series_strong/cpp_ss_unified_v1.tex
...
{\large Unified Submission Package --- Version 1}}
...
Glueball lowest state $\sim$1.5--2~GeV
  & Tetrahedral gluon loop confinement
  & Lattice QCD; consistent \\[4pt]
...
constants follow immediately.  The 8-layer phase interference count
follows from elementary combinatorics: three edges $\times$ two
(real + imaginary) + two diagonal = 8 = dim(su(3)).
...
no closed confinement geometry.  The $\beta$-function coefficient
$\beta_0 = 7$ is derived from $C_A = 3$ and $T_F = 1/2$ (proved
exactly) and $n_f = 6$ (from cage-depth architecture), without
any calibration.  This proves asymptotic freedom.
...
\textbf{This paper} & Unified submission package & v1 \\
\midrule
