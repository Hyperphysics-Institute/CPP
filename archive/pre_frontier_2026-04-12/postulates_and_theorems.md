...
| **THEO-SM8-1** | Bonded Shells | The 600-cell has exactly four bonded polyhedral distance shells: tetrahedron (V=4), icosahedron (V=12), dodecahedron (V=20), icosidodecahedron (V=30). Shell 3 (V=12) has zero edges. | AXIM-2 | SM-8 v4.1, Theorem 3.1 |
| **THEO-SM8-2** | Zero-Parameter Quark Mass | M_q = m_e(z/φ)V^(7/3) × [1 or 16] predicts all four heavy quark masses to RMS 2.1% with zero free parameters. | AXIM-2, A8' | SM-8 v4.1, Theorem 6.1 |
| **THEO-SM8-3** | Three Generations | The tessellated 600-cell lattice supports exactly four independent cage types, corresponding to exactly three quark generations. Outer shells are identified with inner shells of neighboring cells. | AXIM-2 | SM-8 v4.1, Theorem 8.1 |
| **THEO-SM9-1** | Symmetry Degeneracy | For vertex-transitive polyhedra on S², Σ_{i<j} sin²(θ_ij/2) = V²/4 exactly. Angular-weighted pair sums carry no information beyond vertex count. | AXIM-2 | SM-9 v2.2, Theorem 3.1 |
