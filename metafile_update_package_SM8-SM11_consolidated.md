# Metafile Update Package — SM-8/9/10 + SS-2 (Consolidated)

**Purpose:** Combined delta package for all metafile updates from the SM-8/9/10 trilogy and SS-2. Apply after paper production, per `operating_system.md` §10.
...
| r_proton | 0.883 fm | 0.841 fm | +5.0% | 0 | SS-2 |
| μ_proton | 2.789 μ_N | 2.793 μ_N | −0.1% | 0 | SS-2 |
| α_s(m_H) | 0.1132 | 0.1130 | +0.2% | 0 | SS-2 |
```
...
PARTIALLY RESOLVED: OPEN-P-SD-lattice-scale — Lattice spacing
  → SS-2: l_unit = 0.589 fm established. σ derivation still open.
...
| SS-2 | Lattice-Scale Grounding and Nucleon Structure | v1.0 | OSF pending |
```
...
A11 — Lattice-Scale Grounding (SS-2)
...
| P-SS2-1 | r_proton | 0.883 fm | 0.841 fm | +5.0% | A11 | SS-2 |
| P-SS2-2 | μ_proton | 2.789 μ_N | 2.793 μ_N | −0.1% | A11 | SS-2 |
| P-SS2-3 | α_s(m_H) | 0.1132 | 0.1130 | +0.2% | A11 | SS-2 |
| P-SS2-4 | Λ_QCD | 335 MeV | ~330 MeV | +2% | A11 | SS-2 |
| P-SS2-5 | μ_neutron | −1.847 μ_N | −1.913 μ_N | −3.4% | A11 | SS-2 |
| P-SS2-6 | r²_neutron | −0.1161 fm² | −0.1161 fm² | exact | A11+δ | SS-2 |
```
...
| SS-2 v1.0 | A11 | 6 (r_p, μ_p, α_s, Λ, μ_n, r²_n) | 9 | 24+ | 0.38 |
```
...
| P-SS2-1 | r_proton | 0.883 fm | 0.841 fm | +5.0% | 0 | CONFIRMED | SS-2 |
| P-SS2-2 | μ_proton | 2.789 μ_N | 2.793 μ_N | −0.1% | 0 | CONFIRMED | SS-2 |
| P-SS2-3 | α_s(m_H) | 0.1132 | 0.1130 | +0.2% | 0 | CONFIRMED | SS-2 |
| P-SS2-4 | Λ_QCD | 335 MeV | ~330 MeV | +2% | 0 | CONFIRMED | SS-2 |
| P-SS2-5 | μ_neutron | −1.847 μ_N | −1.913 μ_N | −3.4% | 0 | CONFIRMED | SS-2 |
| P-SS2-6 | r²_neutron | −0.1161 fm² | −0.1161 fm² | exact | 1 (δ) | FITTED | SS-2 |
```
...
CONJ-SS-2-1 (String Tension): σ = M₀zπ/(φ l_edge). Status: CONJECTURED. [SS-2 §4]
```
...
**Confinement radius** — The effective radius within which quark colour charge is
  confined by cage geometry. [SS-2]

**Constituent quark mass** — The effective mass of a quark including its surrounding
  DP chain environment, as opposed to the bare current quark mass. [SS-2]
...
**Distortion parameter (ε)** — The ratio by which same-charge quark separation exceeds
  ...
  with colour confinement. Proton: ε = 1.94. [SS-2]

**eCP displacement (δ)** — The fractional inward displacement of the down quark's
  captured electron CP due to linear oscillator dynamics. Neutron: δ = −0.067. [SS-2]

**Force balance** — The equilibrium condition where colour confinement (attractive)
  balances electromagnetic repulsion between same-charge quarks in a nucleon. [SS-2]
...
**Lattice edge** — The 600-cell edge length, equal to 1/φ of the circumradius.
  Physical value: l_edge = 0.364 fm. [SS-2]
...
**Linear oscillator** — The −eCP captured within a down-type quark, oscillating
  ...
  ZBW mass contribution. [SS-2]

**Open vertex** — The fourth vertex of the nucleon's hybrid tetrahedron, not
  occupied by a quark. Provides the binding site for nuclear forces. [SS-2]
...
**String tension (σ)** — The confining force per unit length between quarks.
  CPP value: σ = M₀zπ/(φ l_edge) = 243 MeV/fm. [CONJ, SS-2 §4]
...
**ZBW smearing** — The time-averaged spatial distribution of a quark's charge
  ...
  r_ZBW = ℏc/m_const ≈ 0.631 fm. [SS-2]
```
...
SM-12: Deuteron binding from open-vertex model — NEW
  Use SS-2 proton/neutron structures to predict deuteron binding energy.
...
Derive σ from lattice mode spectrum (SS-series) — NEW
  ...
  Would elevate CONJ-SS-2-1 to theorem.
...
| r_proton | 0.883 fm | 0.841 fm | +5.0%, 0 params | SS-2 |
| μ_proton | 2.789 μ_N | 2.793 μ_N | −0.1%, 0 params | SS-2 |
| α_s(m_H) | 0.1132 | 0.1130 | +0.2%, 0 params | SS-2 |
```
...
| SS-2 | Lattice-Scale Grounding and Nucleon Structure | v1.0 | 10 pages | 10 April 2026 | OSF pending |
```
...
papers/
  ...
  SS-2_lattice_scale_nucleon_structure.tex/.pdf

  (7 documentation suite files each for SM-8, SM-9, SM-10, SS-2 = 28 files)
  ...
  SS-2_review_copilot_v1.0.md, SS-2_review_grok_v1.0.md, SS-2_review_sonnet_v1.0.md
...
development-transcripts/
  ...
  SS-2_development_transcript_opus.md
  angular_pair_model_transcript.md

notebooks/
  SS-2_lattice_scale_nucleon.py
```
...
Add header:
  ...
  SS-2: l_unit = 0.589 fm established via two independent routes.
...
### Already applied (this session):
- [x] `CPP_the_theory.md` — SM-8/9/10 + SS-2 content integrated
- [x] `founders_vision.md` — SM-8/9/10 + SS-2 catalogue entries appended
...
- [ ] `INDEX.md` — all SM-8/9/10 + SS-2 files
