...
\begin{equation}
  ...
  \label{eq:rout}
\end{equation}
This is the geometric constraint that drives all subsequent results.
...
\sqrt{k_e e^2/(8m_e\rin^3)}$.  Substituting:
\begin{equation}
  \frac{\hbar}{2} \;=\; m_e\,\sqrt{\frac{k_e e^2}{8m_e\rin^3}}\,
  \rin^2\,(2\sqrt{2}+4)
  \;=\; (2\sqrt{2}+4)\sqrt{\frac{m_e k_e e^2}{8}}\,\rin^{1/2}.
  \label{eq:quant_eq}
\end{equation}
Solving for $\rin$:
\begin{equation}
  \rin^{1/2} \;=\; \frac{\hbar/2}{(2\sqrt{2}+4)\sqrt{m_e k_e e^2/8}},
  \label{eq:rin_half}
\end{equation}
\begin{equation}
  \rin \;=\; \frac{\hbar^2/4}{(2\sqrt{2}+4)^2 \cdot m_e k_e e^2/8}
  \;=\; \frac{2\hbar^2}{(2\sqrt{2}+4)^2\,m_e k_e e^2}.
  \label{eq:rin_full}
\end{equation}
Noting that $(2\sqrt{2}+4)^2 = 8 + 16\sqrt{2} + 16 = 24 + 16\sqrt{2}
= 4(6+4\sqrt{2}) = 4 \cdot 2(3+2\sqrt{2}) = 8(1+\sqrt{2})^2$:
\begin{equation}
  \rin \;=\; \frac{2\hbar^2}{8(1+\sqrt{2})^2\,m_e k_e e^2}
  \;=\; \frac{\aBohr}{4(1+\sqrt{2})^2}.
  \label{eq:rin_bohr}
\end{equation}
\end{proof}
...
\begin{remark}[Alternative forms]
Using $\aBohr = \rC/\alpha$ where $\rC = \hbar/(m_e c)$ is the
reduced Compton wavelength and $\alpha \approx 1/137$ is the
fine structure constant:
\begin{equation}
  \rin \;=\; \frac{\rC}{4\alpha(1+\sqrt{2})^2},
  \qquad
  \rout \;=\; \frac{\rC}{2\alpha(1+\sqrt{2})^2}.
  \label{eq:rin_compton}
\end{equation}
The orbital radii are set by the Compton wavelength scaled by the
fine structure constant and the geometric factor $4(1+\sqrt{2})^2$.
\end{remark}
...
\textbf{(1) Derivation of $\rout = 2\rin$ from first principles.}
...
\textbf{(2) Mass hierarchy from orbital geometry.}  The electron,
...
\textbf{(3) Quark spin and color.}  The qDP version of the capture
...
\textbf{(4) Spin statistics.}  The Pauli exclusion principle
